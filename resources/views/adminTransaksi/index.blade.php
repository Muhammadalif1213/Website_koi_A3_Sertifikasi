        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
            ...
            <div x-data="{
                ...
                <div class="flex justify-between items-center mb-8">
                    <h1 class="text-4xl md:text-6xl font-bold text-white">Riwayat Transaksi</h1>
                    
                    {{-- Tombol Export PDF --}}
                    <a href="{{ route('admin.transaksi.export') }}" 
                    class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded shadow-lg flex items-center gap-2 transition-colors">
                        {{-- Ikon PDF (SVG) --}}

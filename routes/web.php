...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/transaksi/bukti/{id}', [AdminPesananController::class, 'showBukti'])->name('transaksi.bukti');
    ...
    Route::get('/adminTransaksi/export', [AdminTransaksiController::class, 'exportPdf'])->name('admin.transaksi.export');
